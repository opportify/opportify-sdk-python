...
class AnalyzeFraud200ResponseSourcesIp(BaseModel):
    """
    ...
    connection_type: StrictStr = Field(description="The type of connection associated with the IP address. Allowed values: `wired`, `mobile`, `enterprise`, `satellite`, `vpn`, `cloud-provider`, `open-proxy`, `tor`.", alias="connectionType")
    ...
    risk_report: RiskReportIp = Field(description="Risk report from IP Insights analysis.", alias="riskReport")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalyzeFraud200ResponseSourcesIp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalyzeFraud200ResponseSourcesIp from a dict"""
        if obj is None:
            return None
