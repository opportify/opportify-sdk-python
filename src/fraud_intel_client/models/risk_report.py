...
class RiskReport(BaseModel):
    ...
    level: Optional[StrictStr] = Field(default=None, description="Static representation of the risk level. Allowed values: lowest, low, medium, high, highest.")
    base_analysis: Optional[List[StrictStr]] = Field(default=None, description="Factor codes that contributed to the score.", alias="baseAnalysis")
