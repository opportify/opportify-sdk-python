...
class TestINVALIDPLAN1(unittest.TestCase):
    """INVALIDPLAN1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INVALIDPLAN1:
        """Test INVALIDPLAN1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INVALIDPLAN1`
        """
        model = INVALIDPLAN1()
        if include_optional:
            return INVALIDPLAN1(
                error_message = 'Your plan does not support this feature, please upgrade your plan.',
