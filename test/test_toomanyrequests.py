...
class TestTOOMANYREQUESTS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TOOMANYREQUESTS:
        """Test TOOMANYREQUESTS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TOOMANYREQUESTS`
        """
        model = TOOMANYREQUESTS()
        if include_optional:
            return TOOMANYREQUESTS(
                error_message = 'The account has exceeded the rate limit or usage quota for API requests.',
