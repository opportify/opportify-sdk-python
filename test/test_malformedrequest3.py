...
class TestMALFORMEDREQUEST3(unittest.TestCase):
    """MALFORMEDREQUEST3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MALFORMEDREQUEST3:
        """Test MALFORMEDREQUEST3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MALFORMEDREQUEST3`
        """
        model = MALFORMEDREQUEST3()
        if include_optional:
            return MALFORMEDREQUEST3(
                error_message = 'The request is improperly formatted or missing required data.',
    ...
    def testMALFORMEDREQUEST3(self):
        """Test MALFORMEDREQUEST3"""
