...
class TestINVALIDDATA1(unittest.TestCase):
    """INVALIDDATA1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INVALIDDATA1:
        """Test INVALIDDATA1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INVALIDDATA1`
        """
        model = INVALIDDATA1()
        if include_optional:
            return INVALIDDATA1(
